package de.andorim.ocaAufgaben.main.basics;
    ...
    public static void menu() {
        ...
        while (weiter) {
            ...
            try {
                ...
                switch (eingabe) {
                    case 1:
                        de.andorim.ocaAufgaben.main.basics.d0421.Aufgaben.menu();
                        break;
                    case 2:
                        de.andorim.ocaAufgaben.main.basics.d0422.Aufgaben.menu();
                        break;
                    case 3:
                        de.andorim.ocaAufgaben.main.basics.d0425.Aufgaben.menu();
                        break;
                    case 99:
                        weiter = false;
                        break;
